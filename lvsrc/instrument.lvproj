	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="tests" Type="Folder">
			...
			<Item Name="API" Type="Folder">
				...
				<Item Name="Voltage Source" Type="Folder">
					...
					<Item Name="Instrument" Type="Folder">
						...
						<Item Name="project files" Type="Folder">
							<Item Name="build support" Type="Folder">
								...
								<Item Name="buildspec-template.vipt.rename" Type="Document" URL="../ProjectTemplates/Source/LevyLab/Instrument/project files/build support/buildspec-template.vipt.rename"/>
								<Item Name="icon.ico" Type="Document" URL="../ProjectTemplates/Source/LevyLab/Instrument/project files/build support/icon.ico"/>
								<Item Name="Post-Build Custom Action.vi" Type="VI" URL="../ProjectTemplates/Source/LevyLab/Instrument/project files/build support/Post-Build Custom Action.vi"/>
							</Item>
							<Item Name=".gitattributes" Type="Document" URL="../ProjectTemplates/Source/LevyLab/Instrument/project files/.gitattributes"/>
							<Item Name=".gitignore" Type="Document" URL="../ProjectTemplates/Source/LevyLab/Instrument/project files/.gitignore"/>
							<Item Name="LICENSE" Type="Document" URL="../ProjectTemplates/Source/LevyLab/Instrument/project files/LICENSE"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Enum to String.vim" Type="VI" URL="../SMOs/Instrument/API/Enum to String.vim"/>
		</Item>
