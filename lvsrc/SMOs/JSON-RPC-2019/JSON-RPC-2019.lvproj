...
<Project Type="Project" LVVersion="19008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Find Item (as LVtype).vim" Type="VI" URL="../lv-venv/lv.lib/vi.lib/JDP Science/JSONtext/Find Item (as LVtype).vim"/>
			...
			<Item Name="Find Item.vi" Type="VI" URL="../lv-venv/lv.lib/vi.lib/JDP Science/JSONtext/Find Item.vi"/>
			<Item Name="String Subset.vi" Type="VI" URL="../lv-venv/lv.lib/vi.lib/JDP Science/JSONtext/String Subset.vi"/>
			<Item Name="Parse Full Path or Item Name.vi" Type="VI" URL="../lv-venv/lv.lib/vi.lib/JDP Science/JSONtext/Parsing/Parse Full Path or Item Name.vi"/>
			<Item Name="Next JSON Value.vi" Type="VI" URL="../lv-venv/lv.lib/vi.lib/JDP Science/JSONtext/Next JSON Value.vi"/>
			<Item Name="Error Cluster From Code.vi" Type="VI" URL="../lv-venv/lv.lib/vi.lib/JDP Science/JSONtext/support/Error Cluster From Code.vi"/>
			<Item Name="Find Item Locations by Path.vi" Type="VI" URL="../lv-venv/lv.lib/vi.lib/JDP Science/JSONtext/Offset/Find Item Locations by Path.vi"/>
			<Item Name="JSON text to Variant.vi" Type="VI" URL="../lv-venv/lv.lib/vi.lib/JDP Science/JSONtext/JSON text to Variant.vi"/>
		</Item>
